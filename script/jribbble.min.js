...
var jribbble = function() {
  var a = null,
    t = function(e, t) {
      ...
      }), s.open("GET", r), s.setRequestHeader("Authorization", "Bearer " + a), s.send()
    },
    s = function() {
      for (var e = [].slice.call(arguments), r = null, t = {}, s = function() {}, n = 0; n < e.length; n += 1) switch (typeof e[n]) {
        case "string":
        case "number":
          r = e[n];
          break;
      ...
      if (t.token && (a = t.token), !a) throw new Error("jribbble needs a valid access token. You can either include this as an option: jribbble.shots({token: '1234'}) or with jribbble.setToken('1234')");
      var o = ["page", "per_page"].map(function(e) {
    ...
    r = {
      setToken: function(e) {
        if (!e) throw new Error("jribbble.setToken() expects a valid access_token");
        a = e
      },
      shots: function() {
        var e = s.apply(null, arguments),
